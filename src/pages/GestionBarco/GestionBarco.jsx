...
import TableBarcos from '../../components/TableBarcos/TableBarcos';
import axios from 'axios';
const GestionPuerto = () => {
	const [prueba, setPrueba] = useState([]);
	const mostrarOrdenes = () => {
		axios
			.get('http://localhost:5000/api/naviera/obtener_barcos')
			.then((response) => {
				...
				<div className='row'>
					...
					<div className='col-8'>
						<h5 className='fw-bold text-center mt-4 pt-2 pb-3'>
							Flota Naviera Fluvial
						</h5>
						<div className='row mb-3'>
							<TableBarcos prueba={prueba} />
						</div>
