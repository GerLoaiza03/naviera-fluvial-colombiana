            ...
            <div className="container-fluid mt-3">
                <div className="row">
                    <div className="col-md-6 col-sm-12 border border-0 border-end border-bottom border-4 ">
                        ...
                        <form className="ms-5 me-5 ">
                            <div className="mb-3">
                                <div className="row mb-4">
                                    ...
                                    <div className="col-6">
                                        ...
                                        <select className="form-select" aria-label="Default select example" name="asunto">
                                            <option className="fw-bold" value="" >Seleccione</option>
                                            <option value="">Cotización servicios</option>
                                            <option value="">Recoger carga</option>
                                            <option value="">Entrega de mercancía</option>
                                            <option value="">Demora en entrega</option>
                            ...
                            <div className="d-grid gap-2 col-8 mx-auto mb-5 ">
                                <button type="submit" className="btn btn-primary fw-bold p-2 text-white fw-bold fs-5">
                                    Enviar
                                </button>
                            </div>
                        </form>
                    ...
                    <div className="col-6 border border-0  border-bottom border-2">
                        <h3 className="fw-bold text-center mb-2 pb-1">Para tener el gusto de atenderte ...</h3>
                        <h5 className="fw-bold text-center pb-5">...Contactanos en</h5>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br/>
                                        <button class="btn btn-primary mb-1">
                                        <svg style={{}}xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
